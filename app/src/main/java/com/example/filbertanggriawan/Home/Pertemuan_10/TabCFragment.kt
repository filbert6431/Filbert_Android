...
import com.example.filbertanggriawan.databinding.FragmentMoreBinding
import com.example.filbertanggriawan.databinding.FragmentTabCBinding
...
class TabCFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvProducts.apply {
            /** Mode Grid **/
            layoutManager = GridLayoutManager(requireContext(), 1) // span count, untuk menampilkan datanya dalam x kolom
